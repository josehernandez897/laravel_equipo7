...
<body style="background-color:#F8FCFB;">
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('proyectoG.index') }}">{{ __('Ver Proyectos') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('proyectos.index') }}">{{ __('Mis Proyectos') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('tblcategoria.index') }}">{{ __('Categorias de Proyectos') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">{{ __('Mapa de sitio') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">{{ __('Ayuda') }}</a>
                        </li>
                        <li class="nav-item">
